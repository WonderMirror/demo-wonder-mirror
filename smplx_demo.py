...
def main(model_folder,
    ...
    betas = torch.tensor([[-0.0986, -0.3730,  1.8894, -1.8670, -1.0308, -1.9889, -0.3782, -0.5257, 0.5460,  0.0810]])
    ...
    if plotting_module == 'pyrender':
        ...
        # o3d.io.write_triangle_mesh("template_tpose_female.ply", mesh)
        ...
        if plot_joints:
            ...
            # o3d.io.write_point_cloud("female_joints.pcd", joints_pcl)
